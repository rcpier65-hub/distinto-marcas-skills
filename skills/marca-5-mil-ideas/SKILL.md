...
Distinto Agencia **NO opera el inbox de TikTok** para Mil Ideas. La skill `responder-tiktok` está configurada para **saltar esta marca** (campo `no_trabajado: true` en `responder-tiktok/marcas.json`).

Si el usuario menciona "revisa comentarios TikTok de Mil Ideas" → avisar que esta marca está fuera del servicio TikTok.
