...
- *"Revisa los comentarios de TikTok de Little Joe"*
- *"Generame la hoja para responder TikTok de Little Joe"*
- *"Saca los comentarios de Little Joe"*
...
3. Escribe **hoja nueva** en el Excel:
   ```
   Drive/Mi unidad/1. GESTIÓN/CUENTAS/4. Little Joe/Inbox TikTok/
...
- *"Ya terminé con TikTok de Little Joe"*

Workflow:
1. Verifica el inbox actual (re-lectura para confirmar cuántos quedan sin responder)
2. Compara con el último log
3. Si todo OK → envía resumen al grupo WhatsApp **"New team"** mencionando al contacto del cliente (datos en `marcas.json`)
4. Si quedan nuevos → avisa a Pedro antes de enviar

**Grupo WhatsApp configurado**: `New team`
