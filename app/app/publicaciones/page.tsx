...
// Vista global de publicaciones (todas las marcas, mes de mayo 2026)
// Filtros vía searchParams: ?marca=manrique&estado=aprobar&semana=2026-05-18
...
// Color del badge por estado (para distinguir visualmente el workflow)
...
export default async function PublicacionesPage({
  ...
  // Defaults: mes de mayo 2026 completo
  ...
  // Si filtramos por slug de marca pero no aplica directamente, filtramos client-side
  // (Supabase no permite filtrar por columna de tabla relacionada vía .eq con join)
    ...
    <main className="container mx-auto p-6 max-w-7xl">
      ...
      <Card className="mb-4">
        <CardContent className="p-4">
          <form className="flex flex-wrap gap-3 items-end" action="/publicaciones">
            ...
            {(sp.marca || sp.estado || sp.desde || sp.hasta) && (
              <Link
                href="/publicaciones"
                className="h-9 px-3 rounded-md border text-sm font-medium hover:bg-muted flex items-center"
              >
                Limpiar
              </Link>
            )}
