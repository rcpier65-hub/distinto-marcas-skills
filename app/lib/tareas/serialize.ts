...
export const TAREA_SELECT = `id, team_member_id, created_by, texto, categoria, color, completada, completada_at, focus_lane, created_at, marca_slug, diseno_id,
