...
export function CommandPalette({ open, onClose, marcas = MARCAS_NAV, permisos }: Props) {
  ...
  const actions: Action[] = useMemo(() => [
    ...
    { id: 'nav-recordings',    title: 'Grabaciones y Reuniones',                                            category: 'navegacion', icon: <IconVideo />,    shortcut: ['G', 'R'], keywords: 'video shooting reunion calendario', href: '/grabaciones/calendario', requiereModulo: 'publicaciones' },
