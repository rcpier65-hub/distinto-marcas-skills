...
const TOOLS = [
    {
        name: 'list_marcas',
        description: 'Lista todas las marcas activas de Distinto Agencia (Manrique, TypHouse, Kintu, Lozano, etc.) con su nombre, slug, color, emoji, y objetivo de grabaciones mensuales. Útil para descubrir qué marcas existen antes de filtrar otras tools por marca.',
        inputSchema: {
            type: 'object',
            properties: {},
    ...
    },
    {
        ...
        description: 'Lista las publicaciones programadas para la semana actual (lunes a domingo) en TODAS las marcas o filtradas por una marca específica. Devuelve título, fecha de publicación, estado, plataformas (Instagram/Facebook/TikTok), tipo de contenido y editor asignado.',
        inputSchema: {
            type: 'object',
            properties: {
                marca_slug: {
    ...
    },
    {
        ...
        description: 'Lista publicaciones del mes en curso. Útil para reportes mensuales y vista panorámica.',
        inputSchema: {
            type: 'object',
            properties: {
                marca_slug: {
    ...
    },
    {
        ...
        description: 'Lista las grabaciones planeadas a futuro (fecha >= hoy) con su fecha, hora (AM/PM), marca, estado y notas. Útil para coordinar con camarógrafos, recordar al equipo, o ver disponibilidad de calendario.',
        inputSchema: {
            type: 'object',
            properties: {
                marca_slug: {
    ...
    },
    {
        ...
        description: 'Lista los comentarios de redes sociales (Instagram, Facebook, TikTok) que el equipo todavía no respondió. Útil para que Pedro vea qué está pendiente sin abrir la app y para asignar prioridades.',
        inputSchema: {
            type: 'object',
            properties: {
                marca_slug: {
    ...
    },
    {
        ...
        description: 'Lista las tareas de diseño activas (estado="disenar", portada NO lista). Devuelve nombre, marca, fecha de diseño, sub-estado (sin_empezar/en_progreso/listo/pausada) y motivo de pausa si aplica. Útil para revisar el backlog de Ailyn.',
        inputSchema: {
            type: 'object',
            properties: {
                marca_slug: {
    ...
    },
    {
        ...
        description: 'Lista los pendientes rápidos del chat de Inicio que el equipo escribió pero no completó. Cada miembro tiene los suyos; este endpoint devuelve los del admin (Pedro) o todos según permisos.',
        inputSchema: {
            type: 'object',
            properties: {
                completados: {
    ...
    },
    {
        ...
        description: 'Crea un pendiente rápido en el chat de Inicio. La IA del sistema parsea el texto y lo categoriza automáticamente (Diseño, Edición, Comunicación, Investigación, Personal, Urgente, Administrativo). Útil cuando Pedro está pensando algo y quiere anotarlo sin abrir la app.',
        inputSchema: {
            type: 'object',
            properties: {
                texto: {
    ...
    },
    {
        ...
        description: 'Genera el reporte del día del admin (Pedro): qué publicaciones avanzaron, qué tareas se completaron, comentarios respondidos, hábitos cumplidos. Listo para copiar/pegar.',
        inputSchema: {
            type: 'object',
            properties: {},
            additionalProperties: false,
    ...
    },
    {
        ...
        description: 'Devuelve la ficha completa de una marca: voz/tono, audiencia, oferta, sensibilidades, contactos del cliente, objetivos del mes. Útil para que Claude entienda el contexto antes de generar copys, grillas o respuestas a comentarios.',
        inputSchema: {
            type: 'object',
            properties: {
                marca_slug: {
