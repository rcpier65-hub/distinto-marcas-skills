---
name: marca-manrique
description: Activar SIEMPRE que se trabaje contenido, estrategia, copy, atención al cliente, paid media o reportes para Centro Psicológico Manrique ABA. Cubre voz de marca, audiencia, oferta, pilares, KPIs, sensibilidades, competencia y objetivos del mes en curso. Si el usuario menciona Centro Psicológico Manrique ABA, cualquier producto/servicio de la marca, o palabra clave del cliente, USAR ESTE SKILL ANTES de generar cualquier output. NO generar copy, briefs, reportes ni respuestas a DM sin consultar primero los archivos relevantes. NO improvisar voz, datos de productos, métricas ni mensajes — todo está documentado aquí.
---

# Skill: Gestión de marca — Centro Psicológico Manrique ABA

Sistema operativo de marca para que Agencia Distinto produzca trabajo agencia-grade
para **Centro Psicológico Manrique ABA** con consistencia, sin pedir contexto adicional.
...
- *"Generame la hoja para responder TikTok de Manrique"*
- *"Saca los comentarios de Manrique"*
...
3. Escribe **hoja nueva** en el Excel:
   ```
   Drive/Mi unidad/1. GESTIÓN/CUENTAS/2. Centro Psicológico Manrique ABA/Inbox TikTok/
...
- *"Ya respondí los comentarios de Manrique"*
- *"Ya terminé con TikTok de Manrique"*

Workflow:
1. Verifica el inbox actual (re-lectura para confirmar cuántos quedan sin responder)
2. Compara con el último log
3. Si todo OK → envía resumen al grupo WhatsApp **"Marketing Manrique ABA"** mencionando al contacto del cliente (datos en `marcas.json`)
4. Si quedan nuevos → avisa a Pedro antes de enviar

**Grupo WhatsApp configurado**: `Marketing Manrique ABA`
